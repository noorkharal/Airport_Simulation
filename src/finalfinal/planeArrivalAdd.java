...
//
	...
	protected void createContents() {
		...
		shell.setText("Add Plane Arrival");
		...
		lblNewLabel.setBounds(12, 123, 400, 20);
		...
		btnSubmit.addMouseListener(new MouseAdapter() {
			...
			public void mouseDoubleClick(MouseEvent e) {
				...
				if(t.greaterThan(GUI.clock.globalTime)) {
					int location = combo.getSelectionIndex();
					Task temp = new Task(4,1,location, t);
					Main m1 = new Main();
					m1.mainBrain.setTask(temp);
					m1.mainBrain.startArrival();
					shell.close();
				}else {
